            ...
            <c:forEach items="${commentHistoryList}" var="item">
                <div class="one_evaluate">
                    ...
                    <div class="store_info">
                        ...
                        <span class="evaluate_star">星级&nbsp;</span>
                        <c:forEach begin="1" end="${item.stars}" step="1">
                    ...
                    <div class="evaluate_label">
                        ...
                        <c:forEach items="${item.labels}" var="label">
                            <span class="one_label label_on">${label}</span>
                        </c:forEach>
                    </div>
                    <!-- 评价增加了标签 end-->
